...
return [
    ...
    'attributes'             => [
        ...
        /*
        |----------------------------------------------------------------------
        | Champs métier du cabinet fiduciaire (FiducialPro)
        |----------------------------------------------------------------------
        */

        // Identification de l'entreprise cliente
        'company_name'             => 'raison sociale',
        'trade_name'               => 'enseigne commerciale',
        'legal_form'               => 'forme juridique',
        'ice'                      => 'ICE',
        'if_number'                => 'identifiant fiscal (IF)',
        'rc_number'                => 'registre du commerce (RC)',
        'patent_number'            => 'taxe professionnelle (patente)',
        ...
        'contact_first_name'       => 'prénom du représentant',
        'contact_last_name'        => 'nom du représentant',
        'contact_cin'              => 'CIN du représentant',
        'contact_position'         => 'fonction du représentant',
        'contact_phone'            => 'téléphone du représentant',
        'contact_email'            => 'email du représentant',
        ...
        'current_password'         => 'mot de passe actuel',
        'role_id'                  => 'rôle',
        'employee_id'              => 'collaborateur',
        'responsible_id'           => 'responsable',
        'assigned_employee_id'     => 'collaborateur affecté',
        'assigned_date'            => 'date d\'affectation',
        'role_in_dossier'          => 'rôle dans le dossier',
        ...
        'items'                    => 'lignes de prestations',
        'items.*.description'      => 'désignation de la prestation',
        'items.*.quantity'         => 'quantité',
        'items.*.unit_price'       => 'prix unitaire HT',
        ...
        'filing_reference'         => 'référence de télédéclaration',
